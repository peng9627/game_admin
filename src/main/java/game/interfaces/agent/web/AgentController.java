package game.interfaces.agent.web;

import game.application.account.representation.AccountRepresentation;
import game.application.agent.IAgentAppService;
...
public class AgentController extends BaseController {
    ...
    public ModelAndView index() {
        return new ModelAndView("/agent/index", "command", new game.application.agent.command.LoginCommand());
    }
