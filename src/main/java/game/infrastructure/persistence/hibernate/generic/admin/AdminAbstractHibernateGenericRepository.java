package game.infrastructure.persistence.hibernate.generic.admin;
 ...
 */
@Repository
public abstract class AdminAbstractHibernateGenericRepository<T, ID extends Serializable> implements IHibernateGenericRepository<T, ID> {
    ...
    public AdminAbstractHibernateGenericRepository() {
