...
<div class="smart-widget widget-green">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/recharge/pagination?userName=${command.userName!}&isSuccess=${command.isSuccess!}&startDate=${command.startDate}&endDate=${command.endDate}' /]
        [/#if]
            </div>
        </div>
