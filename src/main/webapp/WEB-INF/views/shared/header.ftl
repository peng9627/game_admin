<header class="top-nav">
    <div class="top-nav-inner">
        ...
        <div class="nav-container">
            ...
            <ul class="top-operation">
                <li class="fa top-operation-back">
                    <a class="fa fa-arrow-left fa-lg"></a>
                </li>
                <li class="fa top-operation-refresh">
                    <a class="fa fa-refresh fa-lg"></a>
                </li>
                <li class="fa top-operation-go">
                    <a class="fa fa-arrow-right fa-lg"></a>
                </li>
            </ul>
        </div>
    </div>
