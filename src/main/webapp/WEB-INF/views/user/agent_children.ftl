...
<div class="smart-widget widget-green">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="[@spring.url '/user/agent_children?parent=${user.id!}'/]"
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/user/agent_children?userName=${command.userName!}&nickName=${command.nickName!}&status=${command.status!}&parent=${command.parent!}' /]
        [/#if]
            </div>
        </div>
    </div>
