...
[#include '/shared/header.ftl'/]
                ...
                <ul class="accordion" id="sidebar">
                    ...
                    <li class="bg-palette3">
                        <a href="javascript:void(0)"
                           onclick="load('[@spring.url '/user/agent_children?parent=${command.id}'/]')">
                        <span class="menu-content block">
                            <span class="menu-icon"><i class="block fa fa-users fa-lg"></i></span>
                             <span class="text m-left-sm submenu-label">用户列表</span>
                        </span>
                            <span class="menu-content-hover submenu-label block">用户列表</span>
                        </a>
                    ...
                    <li class="bg-palette3">
                        <a href="javascript:void(0)"
                           onclick="load('[@spring.url '/user/agent_recharge?userName=${command.userName}'/]')">
                        <span class="menu-content block">
    ...
    <iframe class="main-container" src="/user/agent_children?parent=${command.id}" name="ifr" style="width: 100%">
    </iframe>
