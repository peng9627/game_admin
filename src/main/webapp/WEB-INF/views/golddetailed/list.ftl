...
<div class="smart-widget widget-green">
    <div class="smart-widget-header">
        ...
        <form class="form-inline no-margin" role="form">
            ...
            <div class="form-group">
                <label for="flowType" class="control-label">金币流向类型</label>
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    [#if goldDetailed.flowType == 'IN_FLOW']
                                        <td class="red">${goldDetailed.gold!}</td>
                                    [#else]
                                        <td class="green">${goldDetailed.gold!}</td>
                                    [/#if]

                                    <td>${goldDetailed.newGold!}</td>
            ...
            <div class="bg-grey">
                [#if pagination??]
            [@mc.showPagination '/gold_detailed/pagination?userName=${command.userName!}&flowType=${command.flowType!}&startDate=${command.startDate!}&endTate=${command.endDate!}' /]
        [/#if]
            </div>
        </div>
