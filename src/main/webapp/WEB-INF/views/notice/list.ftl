[@override name="title"]系统公告管理[/@override]
...
<div class="row margin-md">
    <a href="/notice/create" class="btn btn-md btn-success">新增系统公告</a>
</div>
<div class="smart-widget widget-green">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/notice/pagination' /]
        [/#if]
            </div>
        </div>
